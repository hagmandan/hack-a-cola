            ...
            <div id="postbox-container-1" class="postbox-container">
                <div id="side-sortables" class="meta-box-sortables">
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <div style="float: right; margin: -15px 0 10px 0"><a href="http://www.staniscia.net/odynogooglegroups" target="_blank"><img src="<?php echo ODY_GOOGLE_GROUPS_URL; ?>/admin/images/logo.png" border="0" alt="logo" /></a></div>
                            <a class="sm_button icon_autor" href="http://www.staniscia.net/odynogooglegroups" target="_blank"><?php _e('Plugin Homepage','odynogooglegroups') ?></a>
                            <a class="sm_button icon_demo"  href="http://www.staniscia.net/demo-odyno-googlegroups/" target="_blank"><?php _e('Live demo','odynogooglegroups') ?></a>
                            <a class="sm_button icon_code"  href="https://github.com/Odyno/OdynoGoogleGroups/issues" target="_blank"><?php _e('Suggest a Feature','odynogooglegroups') ?></a>
                            <a class="sm_button icon_bug"   href="https://github.com/Odyno/OdynoGoogleGroups/issues" target="_blank"><?php _e('Report a Bug','odynogooglegroups') ?></a>
                            <a class="sm_button icon_star"  href="https://wordpress.org/support/view/plugin-reviews/odynogooglegroups?rate=5#postform" target="_blank"><?php _e('Rate the plugin on WordPress.org','odynogooglegroups') ?></a>
                        </div>
                    </div>
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <a class="sm_button flag_en" href="mailto://alessandro@staniscia.net" target="_blank">Alessandro Staniscia</a>
                            <a class="sm_button flag_it" href="mailto://alessandro@staniscia.net" target="_blank">Alessandro Staniscia</a>
                            <span class="sm_button flag_es"><a href="mailto://andrewk@webhostinghub.com" target="_blank">Andrew Kurtis</a> ( <a href="http://www.webhostinghub.com/">WebHostingHub</a> )</span>
                        </div>
                    </div>
                </div>
            </div>
