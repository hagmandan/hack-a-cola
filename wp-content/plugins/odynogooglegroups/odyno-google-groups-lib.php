 ...
 *
 */
function do_odyno_google_groups(
  $name, $id = NULL, $width = "100%", $height = "800px", $showsearch = "false",
 ...
 * @return string
 */
function odyno_google_groups_get_page(
  $name, $id = NULL, $width = "100%", $height = "800px", $showsearch = "false",
  $showtabs = "false", $hideforumtitle = "true", $hidesubject = "true", $domain = NULL
) {
...
function odyno_google_groups_page_shortcut_js(
  ...
  $out .= "&theme=default";
  $out .= "&fragments=true";
  $out .= "&showsearch=" . $showsearchParam;
